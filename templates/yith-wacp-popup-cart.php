...
<table class="cart-list">
	...
	<tr class="single-cart-item">
		...
		<td class="item-thumb">
			<?php
      $construct = CDN_URL . ltrim($_product->get_sku(), '0') . '/featured/120';
      $image = file_get_contents($construct);

      printf( '<a href="%s"><img src="%s" /></a>', esc_url( $_product->get_permalink() ), $image );
